...
class ApiClient extends GetxService {
  ...
  Future<Response> getData(String uri, {Map<String, dynamic>? query, Map<String, String>? headers,bool isModuleIdRquired=false}) async {
    try {
      if (kDebugMode) {
      ...
      if(isModuleIdRquired&&_mainHeaders[AppConstants.moduleId]==null){
         print("DDDDDDDDDDDDDDw1 id ${_mainHeaders[AppConstants.moduleId]}");
      ...
      return response;
        ...
        print("DDDDDDDDDDDDDDw2 id ${_mainHeaders[AppConstants.moduleId]}");
