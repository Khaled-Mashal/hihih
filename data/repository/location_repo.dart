...
class LocationRepo {
  ...
  // }
   // GET
  Future<Response> getAllAddress() async {
    return await GlobalHelper.getDataForController(AppConstants.addressListUri, AppConstants.ALL_ADDRESS, sharedPreferences, apiClient);
  }

  // UPDATE
  Future updateAllAddress() async {
    await GlobalHelper.updateDataForController(AppConstants.addressListUri, AppConstants.ALL_ADDRESS, sharedPreferences, apiClient);
  }
 ...
 Future<Response> getZone(String? lat, String? lng) async {
    return await GlobalHelper.getDataForController('${AppConstants.zoneUri}?lat=$lat&lng=$lng', '${AppConstants.BANNER_LIST}', sharedPreferences, apiClient);
  }

  Future updateZone(String? lat, String? lng) async {
    await GlobalHelper.updateDataForController('${AppConstants.zoneUri}?lat=$lat&lng=$lng', '${AppConstants.BANNER_LIST}', sharedPreferences, apiClient);
  }
