...
class SplashRepo {
  ...
  // GET
  Future<Response> getConfigData() async {
    return await GlobalHelper.getDataForController(AppConstants.configUri, AppConstants.CONFIG_DATA, sharedPreferences, apiClient);
  }

  // UPDATE
  Future updateConfigData() async {
    await GlobalHelper.updateDataForController(AppConstants.configUri, AppConstants.CONFIG_DATA, sharedPreferences, apiClient);
  }
...
// GET
  Future<Response> getModules({Map<String, String>? headers}) async {
    return await GlobalHelper.getDataForController(AppConstants.moduleUri, AppConstants.MODULES, sharedPreferences, apiClient,headers:headers);
  }
// UPDATE
  Future updateModules({Map<String, String>? headers}) async {
    await GlobalHelper.updateDataForController(AppConstants.moduleUri, AppConstants.MODULES, sharedPreferences, apiClient,headers:headers);
  }
