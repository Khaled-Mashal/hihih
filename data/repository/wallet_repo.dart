...
class WalletRepo {
  ...
  // }
    // GET
  Future<Response> getWalletTransactionList(String offset,String sortingType) async {
    return await GlobalHelper.getDataForController('${AppConstants.walletTransactionUri}?offset=$offset&limit=10&type=$sortingType', '${AppConstants.WALLET_TRANSACTION_LIST}_$offset', sharedPreferences, apiClient);
  }

  // UPDATE
  Future updateWalletTransactionList(String offset,String sortingType) async {
    await GlobalHelper.updateDataForController('${AppConstants.walletTransactionUri}?offset=$offset&limit=10&type=$sortingType', '${AppConstants.WALLET_TRANSACTION_LIST}_$offset', sharedPreferences, apiClient);
  }
  ...
  // }
   // GET
  Future<Response> getLoyaltyTransactionList(String offset) async {
    return await GlobalHelper.getDataForController('${AppConstants.loyaltyTransactionUri}?offset=$offset&limit=10', '${AppConstants.LOYALTY_TRANSACTION_LIST}_$offset', sharedPreferences, apiClient);
  }

  // UPDATE
  Future updateLoyaltyTransactionList(String offset) async {
    await GlobalHelper.updateDataForController('${AppConstants.loyaltyTransactionUri}?offset=$offset&limit=10', '${AppConstants.LOYALTY_TRANSACTION_LIST}_$offset', sharedPreferences, apiClient);
  }
