...
class ConfigModel {
  ...
  int? asking_doctor_status;
  String? asking_doctor_phone;
  String? asking_doctor_name;
  String? Ask_doctor_logo;
  int? doctor_online_status;
  String? doctor_online_name;
  String? doctor_online_logo;
  ...
  ConfigModel(
    ...
    this.asking_doctor_status,
    this.asking_doctor_phone,
    this.asking_doctor_name,
    this.Ask_doctor_logo,
    this.doctor_online_status,
    this.doctor_online_name,
    this.doctor_online_logo,
  });
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    asking_doctor_status= json['asking_doctor_status']??0;
    asking_doctor_phone= json['asking_doctor_phone']!=null?json['asking_doctor_phone'].toString():'';
    asking_doctor_name= json['asking_doctor_name']!=null?json['asking_doctor_name'].toString():'';
    Ask_doctor_logo= json['Ask_doctor_logo']!=null?json['Ask_doctor_logo'].toString():'';
    doctor_online_status=json['doctor_online_status']??0;
    doctor_online_name= json['doctor_online_name']!=null?json['doctor_online_name'].toString():'';
    doctor_online_logo= json['doctor_online_logo']!=null?json['doctor_online_logo'].toString():'';
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['asking_doctor_status'] =asking_doctor_status;
    data['asking_doctor_phone'] =asking_doctor_phone;
    data['asking_doctor_name'] =asking_doctor_name;
    data['Ask_doctor_logo'] =Ask_doctor_logo;
    data['doctor_online_status'] =doctor_online_status;
    data['doctor_online_name'] =doctor_online_name;
    data['doctor_online_logo'] =doctor_online_logo;
    return data;
  }
}
