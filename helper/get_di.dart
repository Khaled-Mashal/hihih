...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(() => CouponRepo(apiClient: Get.find(), sharedPreferences: Get.find()));
  ...
  Get.lazyPut(() => ParcelRepo(apiClient: Get.find(), sharedPreferences: Get.find()));
  ...
  Get.lazyPut(() => PaymentMethodRepo(apiClient: Get.find(), sharedPreferences: Get.find()));
  ...
  Get.lazyPut(() => PaymentMethodController(paymentMethodRepo: Get.find()));
