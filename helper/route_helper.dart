...
import 'package:sixam_mart/data/model/response/conversation_doctor_model.dart';
...
import 'package:sixam_mart/view/screens/chat/chat_doctor_screen.dart';
import 'package:sixam_mart/view/screens/chat/chat_screen.dart';
import 'package:sixam_mart/view/screens/chat/conversation_doctor_screen.dart';
...
import 'package:sixam_mart/view/screens/qr/search_qr_result_screen.dart';
import 'package:sixam_mart/view/screens/qr/search_qr_screen.dart';
...
class RouteHelper {
  ...
  static const String messages_doctor = '/new_messages_doctor';
  static const String conversation = '/conversation';
  static const String conversation_doctor = '/new_conversation_doctor';
  ...
  static const String searchQRReslut = '/search-qr-result';
  ...
  static String getSearchQRRoute({String? queryText}) =>
      '$searchQRReslut?query=${queryText ?? ''}';
  ...
  static String getChatRoute(
    ...
    return '$messages?notification=$notificationBody0&user=$user0&conversation_id=$conversationID&index=$index&from=${fromNotification.toString()}&clinic=${isClinic.toString()}';
  }

  static String getChatDoctorRoute(
      {required NotificationBody? notificationBody,
      User? user,
      ConversationDoctor? conversationDoctor,
      int? conversationID,
      int? index,
      bool? fromNotification}) {
    //  print("SSSSSSSSSSSSectoion 100002 ${notificationBody!.toJson()}  ");
    String notificationBody0 = 'null';
    if (notificationBody != null) {
      notificationBody0 =
          base64Encode(utf8.encode(jsonEncode(notificationBody.toJson())));
    ...
    String conversationDoctor0 = 'null';
    if (conversationDoctor != null) {
      conversationDoctor0 =
          base64Encode(utf8.encode(jsonEncode(conversationDoctor.toJson())));
    }
    return '$messages_doctor?notification=$notificationBody0&user=$user0&conversationDoctor=$conversationDoctor0&conversation_id=$conversationID&index=$index&from=${fromNotification.toString()}';
  }

  static String getConversationRoute() => conversation;
  static String getConversationDoctorRoute() => conversation_doctor;
  ...
  static String getQRScreen() => QRScreen;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        name: searchQRReslut,
        page: () =>
            getRoute(SearchQRResultScreen(queryText: Get.parameters['query']))),
    GetPage(
        name: store,
        page: () {
          return getRoute(
        ...
        page: () {
          ...
          return getRoute(ChatScreen(
            ...
            index: Get.parameters['index'] != 'null'
                ...
                : null,
            fromNotification: Get.parameters['from'] == 'true',
            isClinic: Get.parameters['clinic'] == 'true',
    ...
    GetPage(
        ...
        page: () {
          ...
          ConversationDoctor? conversationDoctor;
          if (Get.parameters['conversationDoctor'] != 'null') {
            conversationDoctor = ConversationDoctor.fromJson(jsonDecode(utf8
                .decode(base64Url.decode(Get.parameters['conversationDoctor']!
                    .replaceAll(' ', '+')))));
          }
          return getRoute(ChatDoctorScreen(
            notificationBody: notificationBody,
            user: user,
            index: Get.parameters['index'] != 'null'
                ? int.parse(Get.parameters['index']!)
    ...
    GetPage(
        name: conversation_doctor,
        page: () => const ConversationDoctorScreen()),
    GetPage(
    ...
    GetPage(name: QRScreen, page: () => const SearchQRScreen()),
  ];
