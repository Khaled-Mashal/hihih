...
class WebChatDoctorView extends StatefulWidget {
  final ScrollController scrollController;
  final ConversationsDoctorModel? conversation;
  final ChatController chatController;
  final TextEditingController searchController;
  final Function initCall;

  const WebChatDoctorView({
    Key? key,
  ...
  @override
  State<WebChatDoctorView> createState() => _WebChatDoctorViewState();
}

class _WebChatDoctorViewState extends State<WebChatDoctorView>
