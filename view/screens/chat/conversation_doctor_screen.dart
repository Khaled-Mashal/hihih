...
import 'package:sixam_mart/view/screens/chat/widget/web_chat_doctor_view.dart';
import 'package:sixam_mart/view/screens/search/widget/search_field.dart';

class ConversationDoctorScreen extends StatefulWidget {
  const ConversationDoctorScreen({Key? key}) : super(key: key);

  @override
  State<ConversationDoctorScreen> createState() =>
      _ConversationDoctorScreenState();
}

class _ConversationDoctorScreenState extends State<ConversationDoctorScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      return Scaffold(
        ...
        floatingActionButton: (chatController.conversationDoctorModel != null &&
            ...
            : Padding(
                ...
                child: Column(children: [
                  (Get.find<AuthController>().isLoggedIn() &&
                          ...
                          chatController.conversationDoctorModel!.conversations!
                              .isNotEmpty)
                      ? Center(
                          child: SizedBox(
                  ...
                  SizedBox(
                      height: (Get.find<AuthController>().isLoggedIn() &&
                              conversation != null &&
                              conversation.conversations != null &&
                              chatController.conversationDoctorModel!
                                                            ...
                                                            child: Row(
                                                                children: [
                                                                  ClipOval(
                                                                    ...
                                                                    width: 50,
                                                                    image:
                                                                        '$baseUrl/${conversation.conversations![index]!.logo ?? ''}',
                                                                  )),
                                                                  const SizedBox(
                                                                      width: Dimensions
                                                                          .paddingSizeSmall),
                                                                  Expanded(
                                                                      child: Column(
                                                                        ...
                                                                        conversation.conversations![index]! !=
                                                                                null
                                                                            ? Text(
                                                                                '${conversation.conversations![index]!.name} ',
                                                                                style: robotoMedium,
                                                                              )
