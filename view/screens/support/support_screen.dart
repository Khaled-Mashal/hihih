          ...
          child: ResponsiveHelper.isDesktop(context)
              ...
              : SizedBox(
                  ...
                  child: Column(children: [
                    ...
                    Image.asset(Images.talabatakExpress, height: 100),
                    // const SizedBox(height: 30),

                    // Image.asset(Images.talabatakExpress, width: 200),
                    // const SizedBox(height: Dimensions.paddingSizeSmall),
              ...
              fontSize: 20, color: Theme.of(context).primaryColor,
                    ...
                    SupportButton(
                      ...
                      onTap: () async {
                        var whatsappUrl =
                            "https://www.facebook.com/profile.php?id=61554695282094&mibextid=ZbWKwL";
                        await canLaunch(
                          whatsappUrl,
                        )
                            ? launch(whatsappUrl)
                    ...
                    SupportButton(
                      ...
                      info: "+967781661669",
                      onTap: () async {
                        var whatsappUrl = "whatsapp://send?phone=+967781661669";
                        await canLaunch(
                          whatsappUrl,
                        )
                            ? launch(whatsappUrl)
