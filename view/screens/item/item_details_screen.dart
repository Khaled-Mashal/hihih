                                    ...
                                    (false /*Get.find<SplashController>().configModel!.moduleConfig!.module!.stock! && stock! <= 0*/)
                                        ...
                                        : itemController.item!
                                            ...
                                            : itemController.cartIndex != -1
                                                ...
                                                : 'add_to_cart'.tr,
                                onPressed:
                                    (true /*!Get.find<SplashController>().configModel!.moduleConfig!.module!.stock! || stock! > 0*/)
                                        ? () {
                                            if (true /*!Get.find<SplashController>().configModel!.moduleConfig!.module!.stock! || stock! > 0*/) {
      ...
      onTap: () {
        if (isExistInCart) {
          if (!isIncrement && quantity! > 1) {
            ...
            if (true /*quantity! < stock! || !Get.find<SplashController>().configModel!.moduleConfig!.module!.stock!*/) {
              Get.find<CartController>()
