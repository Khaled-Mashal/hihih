...
class ItemCampaignView2 extends StatelessWidget {
  const ItemCampaignView2({Key? key}) : super(key: key);
      ...
      return (campaignController.itemCampaignList != null && campaignController.itemCampaignList!.isEmpty) ? const SizedBox() : Column(
        children: [
          ...
          SizedBox(
            ...
            ) : ItemCampaign2Shimmer(campaignController: campaignController),
          ),
        ],
      );
    });
...
class ItemCampaign2Shimmer extends StatelessWidget {
  final CampaignController campaignController;
  const ItemCampaign2Shimmer({Key? key, required this.campaignController}) : super(key: key);
