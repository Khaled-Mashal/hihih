...
class PopularStoreView2 extends StatelessWidget {
  ...
  const PopularStoreView2({Key? key, required this.isPopular, required this.isFeatured}) : super(key: key);
      ...
      return (storeList != null && storeList.isEmpty) ? const SizedBox() : Column(
        children: [
          ...
          SizedBox(
            ...
            ) : PopularStore2Shimmer(storeController: storeController),
          ),
        ],
      );
    });
...
class PopularStore2Shimmer extends StatelessWidget {
  final StoreController storeController;
  const PopularStore2Shimmer({Key? key, required this.storeController}) : super(key: key);
