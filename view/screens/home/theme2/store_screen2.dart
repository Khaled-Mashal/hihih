...
class _StoreScreen2State extends State<StoreScreen2> {
  ...
  Future<void> initDataCall() async {
    if (Get.find<StoreController>().isSearching) {
      Get.find<StoreController>().changeSearchStatus(isUpdate: false); //Z00
    }
            ...
            return (storeController.store != null &&
                ...
                ? CustomScrollView(
                    ...
                    slivers: [
                                                  ...
                                                  child: Column(
                                                    ...
                                                    GestureDetector(
                                                      ...
                                                      child: Text(
                                                        // address dd
                                                        store.address ?? '',
                                                        // "wefhiweuhfiwe hfiw iuwehfi hweiufhwe iuf wiuefhwi efhiwefh eiwuhfiwuehfiewhf iew fiwhefihweiufhwiefhiweufhieuwfuiehf iewhfiewhfi ",
                                                        maxLines: 4,
                                                        overflow: TextOverflow
                                                            .ellipsis,
                      ...
                      //             child: SizedBox(
                      //               width: Dimensions.webMaxWidth,
                      //               height: ResponsiveHelper.isDesktop(context) ? 300 : 127,
                      //               child: Column(
                      ...
                      //     SizedBox(
                      //       height: ResponsiveHelper.isDesktop(context) ? 150 : 127,
                      //       child: ListView.builder(
                      //         scrollDirection: Axis.horizontal,
                      //         itemCount: storeController.recommendedItemModel!.items!.length,
                      //         physics: const BouncingScrollPhysics(),
                  ...
                  return FloatingActionButton.extended(
                    onPressed: () async {
                      ...
                      await Get.toNamed(RouteHelper.getChatRoute(
                          notificationBody:
                              NotificationBody(restaurantId: store!.vendorId),
                          user: User(
                              id: store.vendorId,
                              fName: store.name,
                              lName: '',
