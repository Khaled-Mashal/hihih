            ...
            children: [
              Expanded(
                child: SizedBox(
                  ...
                  ) : Category2Shimmer(categoryController: categoryController),
                ),
              ),
              ...
              ): CategoryAll2Shimmer(categoryController: categoryController)
            ],
          ),
...
class Category2Shimmer extends StatelessWidget {
  final CategoryController categoryController;
  const Category2Shimmer({Key? key, required this.categoryController}) : super(key: key);
...
class CategoryAll2Shimmer extends StatelessWidget {
  final CategoryController categoryController;
  const CategoryAll2Shimmer({Key? key, required this.categoryController}) : super(key: key);
