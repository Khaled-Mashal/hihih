...
class PopularItemView2 extends StatelessWidget {
  ...
  const PopularItemView2({Key? key, required this.isPopular}) : super(key: key);
      ...
      return (itemList != null && itemList.isEmpty) ? const SizedBox() : Column(
        children: [
          ...
          SizedBox(
            ...
            ) : PopularItem2Shimmer(enabled: itemList == null),
          ),
        ],
      );
    });
...
class PopularItem2Shimmer extends StatelessWidget {
  final bool enabled;
  const PopularItem2Shimmer({Key? key, required this.enabled}) : super(key: key);
