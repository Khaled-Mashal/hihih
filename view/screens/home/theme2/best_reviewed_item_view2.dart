...
class BestReviewedItemView2 extends StatelessWidget {
  const BestReviewedItemView2({Key? key}) : super(key: key);
      ...
      return (itemList != null && itemList.isEmpty) ? const SizedBox() : Column(
        children: [
          ...
          SizedBox(
                            ...
                            Padding(
                              ...
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.end, children: [
                                  if(itemList[index].price==0.0)
                                  Text(
                                    PriceConverter.convertPriceV2(itemList[index].price
                                    ),
            ...
            ) : BestReviewedItem2Shimmer(itemController: itemController),
          ),
        ],
      );
    });
...
class BestReviewedItem2Shimmer extends StatelessWidget {
  final ItemController itemController;
  const BestReviewedItem2Shimmer({Key? key, required this.itemController}) : super(key: key);
