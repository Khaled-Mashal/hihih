                    ...
                    child: Column(
                        ...
                        children: [
                            ...
                            return Column(children: [
                              storeController.popularStoreList == null
                                  ? WebPopularStoreView(
                                      ...
                                      isPopular: true)
                                  : storeController.popularStoreList!.isEmpty
                                      ? const SizedBox()
                                      : WebPopularStoreView(
                                          storeController: storeController,
                                          isPopular: true),
                              SizedBox(
                                  height: (storeController.popularStoreList !=
                                              null &&
                                          storeController
                                              .popularStoreList!.isNotEmpty)
                          ...
                          GetBuilder<ItemController>(builder: (itemController) {
                            return Column(children: [
                              itemController.popularItemList == null
                                  ? WebPopularItemView(
                                      itemController: itemController,
                                      isPopular: true)
                                  : itemController.popularItemList!.isEmpty
                                      ? const SizedBox()
                                      : WebPopularItemView(
                                          itemController: itemController,
                                          isPopular: true),
                            ...
                            return Column(children: [
                              storeController.latestStoreList == null
                                  ? WebPopularStoreView(
                                      storeController: storeController,
                                      isPopular: false)
                                  : storeController.latestStoreList!.isEmpty
                                      ? const SizedBox()
                                      : WebPopularStoreView(
                                          storeController: storeController,
                                          isPopular: false),
                              SizedBox(
                                  height: (storeController.latestStoreList !=
                                              null &&
                                          storeController
                                              .latestStoreList!.isNotEmpty)
                                      ? Dimensions.paddingSizeDefault
                                      : 0),
                            ]);
                          }),
                              ...
                              itemController.reviewedItemList == null
                                  ...
                                  : itemController.reviewedItemList!.isEmpty
                                      ...
                                      : WebPopularItemView(
                                          ...
                                          isPopular: false),
                              SizedBox(
                                  height: (itemController.reviewedItemList !=
                                              null &&
                                          itemController
                                              .reviewedItemList!.isNotEmpty)
                                      ? Dimensions.paddingSizeDefault
                                      : 0),
                            ]);
                          }),
