...
class SplashScreenState extends State<SplashScreen> {
  ...
  void _route() {
    Get.find<SplashController>().getConfigData().then((isSuccess) {
            ...
            if(widget.body != null) {
              if (widget.body!.notificationType == NotificationType.order) {
                ...
                Get.offNamed(RouteHelper.getNotificationRoute(fromNotification: true));
                  ...
                  if(widget.body!.senderType !='vendor'&&widget.body!.senderType !='delivery_man'&&widget.body!.senderType !='admin'&&widget.body!.senderType !='user')
                  {
                   Get.offNamed(RouteHelper.getChatDoctorRoute(notificationBody: widget.body, conversationID: widget.body!.conversationId, fromNotification: true));
                  }
                  else{
      ...
      Get.find<SplashController>().updateConfigData(loadLandingData: GetPlatform.isWeb);
    });
  }
