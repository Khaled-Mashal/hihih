...
import 'package:sixam_mart/view/screens/qr/search_result_widget.dart';
...
class SearchQRResultScreen extends StatefulWidget {
  final String? queryText;
  const SearchQRResultScreen({Key? key, required this.queryText}) : super(key: key);

  @override
  SearchQRScreenState createState() => SearchQRScreenState();
}

class SearchQRScreenState extends State<SearchQRResultScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    Get.find<SearchingController>().getQRHistoryList();
              ...
              return Column(children: [
                              ...
                              SizedBox(
                                  ...
                                  child: GetBuilder<SearchingController>(builder: (searchController) {
                                    ...
                                    return SearchField(
                                      ...
                                      hint: Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText! ? 'search_food_or_restaurant'.tr : 'search_item_or_store'.tr,
                ...
                Expanded(
                    child: searchController.isSearchMode
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    searchController.historyList.isNotEmpty
                                        ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                            ...
                                            InkWell(
                                              onTap: () => searchController.clearSearchQRAddress(),
                                              child: Padding(
                                        ...
                                        itemBuilder: (context, index) {
                                          return ResponsiveHelper.isDesktop(context)
                                              ? Container(
                                                  ...
                                                  child: InkWell(
                                                    onTap: () => searchController.searchQRData(searchController.historyList[index], false),
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        InkWell(
                                                          onTap: () => searchController.removeQRHistory(index),
                                                          child: Padding(
                                        ...
                                        ? searchController.suggestedItemList!.isNotEmpty
                                            ? GridView.builder(
                                                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                                  ...
                                                  childAspectRatio: ResponsiveHelper.isMobile(context) ? (1 / 0.4) : (1.8 / 0.1),
                        ...
                        : SearchQRResultWidget(searchText: _searchController.text.trim(), tabController: ResponsiveHelper.isDesktop(context) ? _tabController : null)),
              ]);
            }),
          )),
  ...
  void searchData() {
    if (_searchController.text.trim().isEmpty) {
      showCustomSnackBar(Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText! ? 'search_food_or_restaurant'.tr : 'search_item_or_store'.tr);
    } else {
  ...
  void _actionSearch(bool isSubmit, String? queryText, bool fromHome) {
    if (Get.find<SearchingController>().isSearchMode || isSubmit) {
      if (queryText!.isNotEmpty) {
        Get.find<SearchingController>().searchQRData(queryText, fromHome);
      } else {
        showCustomSnackBar(Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText! ? 'search_food_or_restaurant'.tr : 'search_item_or_store'.tr);
      }
    } else {
