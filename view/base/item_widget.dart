...
class ItemWidget extends StatelessWidget {
  ...
  const ItemWidget({Key? key, required this.item, required this.isStore, required this.store, required this.index,
   required this.length, this.inStore = false, this.isCampaign = false, this.isFeatured = false, this.fromCartSuggestion = false, this.imageHeight, this.imageWidth, this.isCornerTag = false, this.isRelated = false}) : super(key: key);
    ...
    return InkWell(
      onTap: () {
        if(isStore) {
          ...
          if(isRelated??false){  Navigator.of(context).pop(); }
